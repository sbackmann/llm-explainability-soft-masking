import numpy as np
from syntax_shap.syntaxshap._serializable import Deserializer, Serializer
from transformers import set_seed
from syntax_shap.syntaxshap.utils import safe_isinstance
import torch
...
class TextGeneration(Model):
    ...
    def get_outputs(self, X):
        ...
        if (hasattr(self.inner_model.config, "is_decoder")) or getattr(self.inner_model.config, "is_decoder", True):
